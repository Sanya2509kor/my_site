...
$(document).ready(function () {
    ...
    $(document).on("click", ".cart-btn-decrement", function (e) {
        ...
        if (currentValue > 1) {
            ...
            // Запускаем функцию обновления корзины
            updateCart(cartID, currentValue - 1, -1, url, $(this).find("[name=csrfmiddlewaretoken]").val());
        }
    });
    ...
    function updateCart(cartID, quantity, change, url, csrfToken) {
        $.ajax({
            type: "POST",
            url: url,
            data: {
